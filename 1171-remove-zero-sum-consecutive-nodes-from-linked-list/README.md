...
<pre style="position: relative;"><strong>Input:</strong> head = [1,2,-3,3,1]
...
<pre style="position: relative;"><strong>Input:</strong> head = [1,2,3,-3,4]
<strong>Output:</strong> [1,2,4]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> head = [1,2,3,-3,-2]
