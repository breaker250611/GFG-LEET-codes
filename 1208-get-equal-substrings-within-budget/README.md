...
<pre style="position: relative;"><strong>Input:</strong> s = "abcd", t = "bcdf", maxCost = 3
...
<pre style="position: relative;"><strong>Input:</strong> s = "abcd", t = "cdef", maxCost = 3
...
<pre style="position: relative;"><strong>Input:</strong> s = "abcd", t = "acde", maxCost = 0
<strong>Output:</strong> 1
