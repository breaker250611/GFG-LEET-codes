...
<pre style="position: relative;"><strong>Input:</strong> position = [1,2,3,4,7], m = 3
...
<pre style="position: relative;"><strong>Input:</strong> position = [5,4,3,2,1,1000000000], m = 2
